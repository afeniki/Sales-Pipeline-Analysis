...
ToolPurposeSQLData cleaning, transformation, metric calculationPower BIInteractive dashboard and data visualizationMicrosoft ExcelData validation and preliminary exploration
